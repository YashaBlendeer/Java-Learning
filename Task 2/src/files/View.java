...
public class View {
    ...
    public static final String VALUE_OUT_OF_RANGE = "This value is out of range! ";

    public static final String WRONG_INPUT_DATA = "Wrong input! Repeat please! ";
    public static final String WRONG_NUMBER_VALUE = "That's not the generated number. Try again. ";
    public static final String CORRECT_NUMBER_VALUE = "That's the correct number. You won!";
